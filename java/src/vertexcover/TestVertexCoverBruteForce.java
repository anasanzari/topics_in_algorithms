...
public class TestVertexCoverBruteForce {
	...
	public void simpleTest() {
		...
		Cover cover = VertexCoverBruteForce.vertex_cover_bf(graph, 2);
		printCover(cover);
	...
	public void simpleTest2() {
		...
		Cover cover = VertexCoverBruteForce.vertex_cover_bf(graph, 1);
		printCover(cover);
	...
	public void simpleTest3() {
		...
		Cover cover = VertexCoverBruteForce.vertex_cover_bf(graph, 3);
		printCover(cover);
		assertEquals(true, cover.isCoverable);
	}
	...
	public void bigTest1() {
		try {
			...
			int k = sc.nextInt();
			sc.close();
			Cover cover = VertexCoverBruteForce.vertex_cover_bf(g, k);
			printCover(cover);
			assertEquals(true, cover.isCoverable);
		} catch (Exception e) {
			e.printStackTrace();
